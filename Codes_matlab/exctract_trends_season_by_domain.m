...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clc; clear all ;
main_dir='G:\PROJETS\PROJET_CORDEX\CORDEX-NAM44\TENDANCES_SAISON\';
out_dir='G:\PROJETS\PROJET_2018\TENDANCES_RCMs\SEASON\';

list_domaine={'Domaine1','Domaine2','Domaine3','Domaine4'};
list_station={'domaine1','domaine2','domaine3','domaine4'};

List_mon = {'DJF','JJA','MAM','SON'};
period1='2011-2040';
period2='2041-2070';
period3='2071-2100';
ref='1971-2000';
...
for d=1:4 %boucle sur les domaines a extraire
    ...
    for tt=1:length(List_mon)  %Boucle sur les mois
            mois=List_mon(tt);  
        ...
        for mo = 1:mm   %boucle sur les modeles
             ...
             if strcmpi(curr_path,'CRCM5-v1_MPI-M-MPI-ESM-MR_rcp45') ==1  || strcmpi(curr_path,'CANRCM4_CanESM2_rcp45') ==1 || ...
                strcmpi(curr_path,'CRCM5-v1_CCCma-CanESM2_rcp45')==1 || strcmpi(curr_path,'RCA4.v1_CCCma-CanESM2_rcp45')==1 || ...
                strcmpi(curr_path,'RCA4.v1_ICHEC-EC-EARTH_rcp45')==1 || strcmpi(curr_path,'HIRHAM5_ICHEC-EC-EARTH_rcp45') ==1
             period3 = '2071-2098';      
             end
         ...
         csvwrite(strcat(out_dir,char(domaine),'_Tendances_RCP45_',char(var1),'_',char(period1),'_',char(mois),'.csv'),rcp45_fin1)
         csvwrite(strcat(out_dir,char(domaine),'_Tendances_RCP45_',char(var1),'_',char(period2),'_',char(mois),'.csv'),rcp45_fin2)
         csvwrite(strcat(out_dir,char(domaine),'_Tendances_RCP45_',char(var1),'_2071-2100_',char(mois),'.csv'),rcp45_fin3)
        ...
        for mo = 1:mm   %boucle sur les modeles
             ...
             period3 = '2071-2098';  
             elseif strcmpi(curr_path,'RCA4.v1_CCCma-CanESM2_rcp85')==1 || strcmpi(curr_path,' RCA4.v1_ICHEC-EC-EARTH_rcp85')==1 
             period3 = '2071-2098';  
             elseif strcmpi(curr_path,'RegCM4_GFDL-ESM2M_rcp85')==1 || strcmpi(curr_path,'RegCM4_HadGEM2-ES_rcp85')==1 || strcmpi(curr_path,'RegCM4_MPI-ESM-LR_rcp85')==1
             period3 = '2071-2098';
     ...
     %    mat29=mat29';
      ...
      %   mat39=mat39';
         ...
         csvwrite(strcat(out_dir,char(domaine),'_Tendances_RCP85_',char(var1),'_',char(period1),'_',char(mois),'.csv'),rcp45_fin1)
         csvwrite(strcat(out_dir,char(domaine),'_Tendances_RCP85_',char(var1),'_',char(period2),'_',char(mois),'.csv'),rcp45_fin2)
         csvwrite(strcat(out_dir,char(domaine),'_Tendances_RCP85_',char(var1),'_2071-2100_',char(mois),'.csv'),rcp45_fin3)
          clear rcp45_fin1 rcp45_fin2 rcp45_fin3
       ...
       mm=length(MODEL_LIST);      
        ...
        for j=1:(mm)
         ...
         for l=1:mm
           ...
           csvwrite(strcat(out_dir,char(domaine),'_Tendances_HISTO_',char(var1),'_1971-2000_',char(mois),'.csv'),histo_fin)
         clear histo_fin
