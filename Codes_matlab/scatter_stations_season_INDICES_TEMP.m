...
out='G:\PROJETS\PROJET_2018\DATA\figures\tendances\SEASON\';
...
path='G:\PROJETS\PROJET_2018\DATA\CANADA\INDICES_SEASON\Tasmin\TENDANCES';
elseif (strcmp(char(var),'tasmax')==1)
path='G:\PROJETS\PROJET_2018\DATA\CANADA\INDICES_SEASON\Tasmax\TENDANCES';
elseif (strcmp(char(var),'tasmoy')==1)
path='G:\PROJETS\PROJET_2018\DATA\CANADA\INDICES_SEASON\Tasmoy\TENDANCES';
end
...
set(gca,'FontSize',20);
   ...
   if (strcmp(char(list_mon(m)),'DJF')==1)
     month='Winter';
   elseif (strcmp(char(list_mon(m)),'JJA')==1)
     month='Summer';
   elseif (strcmp(char(list_mon(m)),'MAM')==1)
     month='Spring';
   elseif (strcmp(char(list_mon(m)),'SON')==1)
     month='Automn';     
   end
