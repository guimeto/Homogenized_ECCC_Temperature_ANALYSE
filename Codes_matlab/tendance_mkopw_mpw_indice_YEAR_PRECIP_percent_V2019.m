...
%
dd = 'K:\DATA\Donnees_Stations\2nd_generation_V2018\INDICES_YEAR\Prec_all\';
out='K:\DATA\Donnees_Stations\2nd_generation_V2018\TENDANCES\YEAR\Prec_all\';
...
File=strcat(char(name_stat{1}{s}),'_SEASON_',char(type),'_',char(curr_var),'_',num2str(start_year),'_',num2str(end_year),'_YEAR.csv');
...
Fileref=strcat(char(name_stat{1}{s}),'_SEASON_',char(type),'_',char(curr_var),'_1971_2000_YEAR.csv');
...
save(strcat(out,curr_var,'\INDICES_',type,'_',curr_var,'_YEAR_CANADA_',num2str(start_year),'_',num2str(end_year),'_',char(confiance),'.dat'),'mat_final', '-ASCII');
