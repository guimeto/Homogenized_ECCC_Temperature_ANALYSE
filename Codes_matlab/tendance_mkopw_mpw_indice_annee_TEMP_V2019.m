...
%
dd = 'K:\DATA\Donnees_Stations\2nd_generation_V2019\INDICES\INDICES_YEAR\ANOMALY_STD\';
out='K:\DATA\Donnees_Stations\2nd_generation_V2019\INDICES\INDICES_YEAR\TENDANCES_ANO_STD\Tasmoy\MOY';
curr_var='Tasmoy';
...
File=strcat(char(name_stat{1}{s}),'_ANO_STD_YEAR_',char(curr_var),'_MOY_',num2str(start_year),'_',num2str(end_year),'.csv');
