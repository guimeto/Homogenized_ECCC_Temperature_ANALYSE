...
% periode 1981-2011.
% Auteur: Adapte par Christian Saad
% modifie par Guillaume Dueymes
% Date:  15/09/2016
...
%
dd = 'K:\DATA\Donnees_Stations\2nd_generation_V2019\INDICES\INDICES_YEAR\';
out='K:\DATA\Donnees_Stations\2nd_generation_V2019\INDICES\INDICES_YEAR\TENDANCES_INDICES\Tasmin\MOY';
curr_var='Tasmin';
...
File=strcat(char(name_stat{1}{s}),'_',char(curr_var),'_MOY_',num2str(start_year),'_',num2str(end_year),'_YEAR.csv');
...
save(strcat(out,'\INDICES_MOY_',curr_var,'_YEAR_',char(domaine),'_',num2str(start_year),'_',num2str(end_year),'_',char(confiance),'.dat'),'mat_final', '-ASCII');
