...
start_year=1990;
end_year=2019;
dd = strcat('K:\DATA\Donnees_Stations\2nd_generation_V2019\INDICES\INDICES_MONTH\Tasmoy\MOY\',num2str(start_year),'_',num2str(end_year),'\');
out='K:\DATA\Donnees_Stations\2nd_generation_V2019\INDICES\INDICES_MONTH\TENDANCES_INDICES\Tasmoy\MOY\';
...
File=strcat(char(name_stat{1}{s}),'_MONTH_',char(curr_var),'_MOY_',num2str(start_year),'_',num2str(end_year),'_',char(month(mon)),'.csv');
