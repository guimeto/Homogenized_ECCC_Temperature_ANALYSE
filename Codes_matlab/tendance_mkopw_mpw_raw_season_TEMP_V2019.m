...
%
dd = 'K:\DATA\Donnees_Stations\2nd_generation_V2019\INDICES\INDICES_SEASON\';
out='K:\DATA\Donnees_Stations\2nd_generation_V2019\INDICES\INDICES_SEASON\TENDANCES_INDICES\Tasmoy\MOY';
...
File=strcat(char(name_stat{1}{s}),'_SEASON_',char(curr_var),'_MOY_',num2str(start_year),'_',num2str(end_year),'_',char(seasons(sea)),'.csv');
...
save(strcat(out,'\INDICES_MOY_',curr_var,'_',char(seasons(sea)),'_',char(domaine),'_',num2str(start_year),'_',num2str(end_year),'_',char(confiance),'.dat'),'mat_final', '-ASCII');
